...
module.exports = function (options, logger) {
  ...
  .then(function () {
    ...
    var logFile = `${experiment.directory}/experiment.log`
  ...
  .then(function () {
    ...
    return results.overall(experiment).then(function (overall) {
      ...
      // ensure it finishes logging
      return logger.logPromise(colors.green.bold('Success'))
      .then(function () {
        return overall
      })
    })
    ...
    logger.log(err)
    return logger.logPromise(colors.red.bold('Failed'))
    .then(function () {
